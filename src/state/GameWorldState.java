...
public class GameWorldState extends State {
    ...
    public int openIntroGameY = 0, state = INIT_GAME, previousState = state, tutorialState = INTROGAME;
    ...
    private void TutorialUpdate(){ // các hướng dẫn của game khi bắt đầu game hoặc lúc gặp boss
        switch(tutorialState){
            case INTROGAME:
                ...
                break;
            case MEETFINALBOSS:
                if(storyTutorial == 0){//trạng thái ban đầu
                    if(openIntroGameY >= 450) {
                        openIntroGameY-=1;
                    }
...
//                    g2.fillRect(20, 60, megaMan.getBlood(), 20);
            		...
            		g2.fillRoundRect(18,58,154,24, 20, 20);

            		//Thanh hp
            		g2.setColor(new Color(105,25,25));
            		g2.fillRoundRect(20,60, 150, 20, 20, 20);
            		g2.setColor(new Color(255,0,30));
            		g2.fillRoundRect(20,60, megaMan.getBlood()*3/2, 20, 20, 20);
