...
public class Animation {
	...
	private ArrayList<Boolean> ignoreFrames; // các animation bỏ qua qá trình lặp lại
	...
	public boolean isIgnoreFrame(int id) {// kiểm tra Frame có bị Ignore không
		return ignoreFrames.get(id);
	}
	
	public void setIgnoreFrame(int id) {// set Frame muốn ignore
	...
	public void reset() { // quay về ban đầu
		currentFrame = 0;
		beginTime = 0;
	...
	public void add(FrameImage frameImage, double timeToNextFrame) {// tạo animation
	...
	private void nextFrame(){
        ...
        if(currentFrame >= frameImages.size() - 1){//current là frame cuối
            
            if(isRepeated) currentFrame = 0; // lặp lại -> = 0	
        }
        else currentFrame++;
	...
	public void Update(long currentTime){
        ...
        if(beginTime == 0) beginTime = currentTime;
            ...
            if(currentTime - beginTime > delayFrames.get(currentFrame)){//thời gian hiện tại đến bắt đầu > delay -> chuyển frame
                nextFrame();
