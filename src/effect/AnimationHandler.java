...
public class AnimationHandler {
	...
	//MegaMan Animation
	 ...
	 // FinalBoss Animation
	    ...
	    public void bleed(String name) {
	    	Graphics2D g2 = (Graphics2D) bufferedImage.getGraphics();
            switch (name) {
            case "RedEyeDevil":
    	    	g2.setColor(Color.GRAY);
                g2.fillRect((int) redEyeDevil.getPosX(), (int) (redEyeDevil.getPosY()+5), 102, 22);
                g2.setColor(Color.red);
                g2.fillRect((int) redEyeDevil.getPosX(), (int) (redEyeDevil.getPosY()+5), redEyeDevil.getBlood(), 20);
                break;
            }
	    }
